...
CKEDITOR.plugins.add( '3-column-row', {
	...
	init: function( editor ) {
		...
		editor.widgets.add( '3-column-row', {
			...
			template:
				'<div class="row mb-3 pt-2">' +
					'<div class="col-md editable1"></div>' +
					'<div class="col-md editable2"></div>' +
					'<div class="col-md editable3"></div>' +
					'<div class="col-md editable4"></div>' +
				'</div>',
