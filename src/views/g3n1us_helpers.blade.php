...
*/
	...
	parse_str: function(querystring){
		if(g3n1us_helpers.starts_with(querystring, '?'))
	...
	mime: function(filename){
		...
		else if(g3n1us_helpers.ends_with(path, ".m4v")) mime = "video/mp4";		
  ...
  file_icon: function($path){
  	$path = g3n1us_helpers.strtolower($path);
  	if(g3n1us_helpers.ends_with($path, ".css")) $mime = "fa-file-code";
  	else if(g3n1us_helpers.ends_with($path, ".less")) $mime = "fa-file-code";
  	else if(g3n1us_helpers.ends_with($path, ".sass")) $mime = "fa-file-code";
  	else if(g3n1us_helpers.ends_with($path, ".scss")) $mime = "fa-file-code";
  	else if(g3n1us_helpers.ends_with($path, ".mp4")) $mime = "fa-file-movie";
  	else if(g3n1us_helpers.ends_with($path, ".mov")) $mime = "fa-file-movie";
  	else if(g3n1us_helpers.ends_with($path, ".m4v")) $mime = "fa-file-movie";
  	else if(g3n1us_helpers.ends_with($path, ".avi")) $mime = "fa-file-movie";
  	else if(g3n1us_helpers.ends_with($path, ".js")) $mime = "fa-file-code";
  	else if(g3n1us_helpers.ends_with($path, ".pdf")) $mime = "fa-file-pdf";
  	else if(g3n1us_helpers.ends_with($path, ".svg")) $mime = "fa-file-image";
  	else if(g3n1us_helpers.ends_with($path, ".jpg")) $mime = "fa-file-image";
  	else if(g3n1us_helpers.ends_with($path, ".jpeg")) $mime = "fa-file-image";
  	else if(g3n1us_helpers.ends_with($path, ".png")) $mime = "fa-file-image";
  	else if(g3n1us_helpers.ends_with($path, ".gif")) $mime = "fa-file-image";
  	else if(g3n1us_helpers.ends_with($path, ".ico")) $mime = "fa-file-image";
  	else if(g3n1us_helpers.ends_with($path, ".json")) $mime = "fa-file-code";
  	else if(g3n1us_helpers.ends_with($path, ".ttf")) $mime = "fa-font";
  	else if(g3n1us_helpers.ends_with($path, ".woff")) $mime = "fa-font";
  	else if(g3n1us_helpers.ends_with($path, ".woff2")) $mime = "fa-font";
  	else if(g3n1us_helpers.ends_with($path, ".otf")) $mime = "fa-font";
  	else if(g3n1us_helpers.ends_with($path, ".eot")) $mime = "fa-font";
  	else if(g3n1us_helpers.ends_with($path, ".md")) $mime = "fa-file-word";
  	else if(g3n1us_helpers.ends_with($path, ".swf")) $mime = "fa-file-code";
  	else if(g3n1us_helpers.ends_with($path, ".php")) $mime = "fa-file-code";
  	else if(g3n1us_helpers.ends_with($path, ".doc")) $mime = "fa-file-word";
  	else if(g3n1us_helpers.ends_with($path, ".docx")) $mime = "fa-file-word";
