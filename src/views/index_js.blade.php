<script>
// TODO THIS IS ONLY CURRENTLY USED INSIDE FILEMANAGER TEMPLATE. FIX AND MOVE!!  
// console.error('// TODO THIS IS ONLY CURRENTLY USED INSIDE FILEMANAGER TEMPLATE. FIX AND MOVE!! (src/views/index_js.blade.php)');
...
if(document.getElementById('ckeditor') !== null){
	...
	if(typeof mail_template_url !== "undefined")
		final_ckconfig.contentsCss = ['/CORE_JS/js/ckeditor_styles.css', mail_template_url];
